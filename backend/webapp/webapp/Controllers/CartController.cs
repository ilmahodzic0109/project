...
namespace webapp.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public CartController(ICartService cartService, IUserService userService, ICheckoutService checkoutService, IProductService productService, EmailService emailService)
        {
        ...
        public async Task<IActionResult> TestEmail()
        {
            try
            {
                await _emailService.SendEmailAsync(
                    "ilmahodzic7@gmail.com", 
                    "Test Email",
                    "This is a test email to check the email functionality."
                );
